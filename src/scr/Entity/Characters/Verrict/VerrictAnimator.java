package scr.Entity.Characters.Verrict;
...
public class VerrictAnimator extends CharacterAnimator
{
    public VerrictAnimator(CharacterBaseModel cb) {
        this.cb = cb;
    ...
    protected void setAnimResources() throws IOException {
        animResources.res.put("body",new ResSprites("verrict\\body"));
        animResources.res.put("w",new ResSprites("verrict\\w"));
        animResources.res.put("w1",new ResSprites("verrict\\w1"));
    }
    ...
    protected void setAnimations() {
        ...
        //先装配
        assembleToAnimations("idle",8,9,true);
        assembleToAnimations("walk",0,7,true);
        assembleToAnimations("attack1",9,14,false);
        assembleToAnimations("attack2",15,21,false);
        assembleToAnimations("injure",34,35,false);
        assembleToAnimations("inair",36,38,false);
        assembleToAnimations("death",36,38,false);
    }
    ...
    protected void setStates() {
        ...
        statesList.put(VerrictStatesTable.Attack,new Attack(cb));
        statesList.put(VerrictStatesTable.Attack2,new Attack2(cb));
    ...
    public void render(Graphics g, JPanel jPanel, Transform transform) {
        ...
        if(cb.property.states.equals(VerrictStatesTable.Jump) || cb.property.states.equals(VerrictStatesTable.Fall) || cb.property.states.equals(BaseStates.InAir) || cb.property.states.equals(BaseStates.Throw))
        {
