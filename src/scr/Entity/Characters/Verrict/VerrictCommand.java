...
public class VerrictCommand implements GameObjectAction {
    public CharacterBaseModel cb;
    public VerrictCommand(CharacterBaseModel cb)
    {
        this.cb = cb;
    }
    @Override
    ...
    public void attack()
    {
        cb.property.states = VerrictStatesTable.Attack;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack2()
    {
        cb.property.states = VerrictStatesTable.Attack2;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack3()
    {
        cb.property.states = VerrictStatesTable.Attack3;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void jump(Transform transform)
    {
        cb.property.states = VerrictStatesTable.Jump;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void death()
    {
