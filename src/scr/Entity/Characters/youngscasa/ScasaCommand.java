...
public class ScasaCommand implements GameObjectAction {
    public CharacterBaseModel cb;
    public ScasaCommand(CharacterBaseModel cb)
    {
        this.cb = cb;
    }
    @Override
    ...
    public void attack()
    {
        cb.property.states = ScasaStatesTable.Attack;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack2()
    {
        cb.property.states = ScasaStatesTable.Attack2;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack3()
    {
        cb.property.states = ScasaStatesTable.Attack3;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void jump(Transform transform)
    {
        cb.property.states = ScasaStatesTable.Jump;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void death()
    {
