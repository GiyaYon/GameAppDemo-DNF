...
public class GiselleCommand implements GameObjectAction {
    public CharacterBaseModel cb;
    public GiselleCommand(CharacterBaseModel cb)
    {
        this.cb = cb;
    }
    @Override
    ...
    public void attack()
    {
        cb.property.states = GiselleStatesTable.Attack;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack2()
    {
        cb.property.states = GiselleStatesTable.Attack2;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void attack3()
    {
        cb.property.states = GiselleStatesTable.Attack3;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void jump(Transform transform)
    {
        cb.property.states = GiselleStatesTable.Jump;
        cb.cAnimator.getFsm().ChangeState(cb.property.states);
    }
    public void death()
    {
